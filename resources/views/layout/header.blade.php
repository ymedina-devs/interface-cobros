                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                ...
                                <img src="{{ session()->get('usuario')['authempresaicono'] }}" class="img-radius" alt="User-Profile-Image">
                                <span>{{session()->get('usuario')['authusuarionombre']}}</span>
                            </div>
                            <ul class="pro-body">
                                <li><a href="/auth.desconectar" class="dropdown-item"><i class="feather icon-lock"></i> Cerrar Sesión</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
