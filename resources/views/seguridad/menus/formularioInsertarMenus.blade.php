		...
		<div class="card">
			...
			<div class="card-body">
				<div class="">
					...
					<hr>
					<form method="POST" action="/menus.registrar" name="cr-menus">
						@csrf
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label for="">Nombre del Menú</label>
									<input type="text" name="tx_menu"  class="form-control" id="" aria-describedby="emailHelp" placeholder="">
									<div id="tx_menu"></div>
								</div>
							</div>
							<div class="col-md-5">
								...
								<div class="input-group mb-3">
									...
									<input type="text" name="tx_enlace" class="form-control"  aria-describedby="basic-addon3">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" id="" name="tx_icono">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" name="tp_menu">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" name="cd_padre">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="number" name="nu_consecutivo" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
					...
					<div class="col-md-2 offset-md-10">
						<button class="btn btn-info" onclick="funcInsertarFormulario('cr-menus','/menus.registrar')">Guardar Registro</button>
					</div>
				</div>
			</div>
		</div>
